...
"Our governor is comparatively young. They say that he is not very able man, minor son of Spanish count. He is not a long time here, so for now he didn't make something interesting",
"I see. I have another question for you.",
"Thanks. So long.",
"What can I say. he is just a man. He owns a tavern, so he knows all that is going on on this island.",
"I see. I have another question for you.",
"Thanks. So long.",
"He is not good, this old man. He always grumble when somebody wants to buy a new ship and just dreaming about past.",
"I see. I have another question for you.",
"Thanks. So long.",
"He's known in the town for his honesty and for the quality of his goods.",
"I see. I have another question for you.",
"Thanks. So long.",
...
"Go straight from the seagate through the bridge. You'll see a sign on the building directly in front of you - that's the tavern.",
"Got it. Thanks.",
"Where's the shipyard?",
"Where can I sell the fine goods I've brought with me?",
"The shipyard manager's office is to the left of the market square. Go straight through the bridge from the town seagate and then turn to the left. Then walk some more, and just past a small ladder you'll see the shipyard sign.",
"I see. And how can I get to the tavern?",
"I need to find someone who'll give me a fair price for my goods.",
"Thanks for your help. That's all I need for now.",
"Going from the town seagate, take the first street to the right. Walk down that street until it ends, then go downstairs. There you'll find the shop.",
...
"The history of our island? The colony was established not long ago, \nbut since the island turned out to be very rich and fertile, it grew pretty quickly\nNow it's the biggest and most flourishing colony in our archipelago.",
"Go on.",
